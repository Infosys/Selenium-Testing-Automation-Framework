...
import com.infosys.toolsgroup.selautofwk.license.LicenseValidator;
...
public class MainTestNG { 
	...
	public static void main(String[] args) {
		...
		boolean bValidLicense = lv
				.isValidLicense(new String[] { "TG_SELENIUM_FRAMEWORK" });
		...
		if (bValidLicense) {
			...
			MainTestNG.LOGGER
					.info("Invalid license to use this framework. Please contact Tools Group (AHD --> Quality --> Tools Group");
		}
	}
